 ...
 *
 * @brief <b>Defined Constants and Types for the LM3S USB Controller</b>
 *
...
#ifndef LIBOPENCM3_LM3S_USB_H
#define LIBOPENCM3_LM3S_USB_H
...
/* USB Device Control */
#define USB_DEVCTL			MMIO8(USB_BASE + 0x60)
...
#define USB_VPLEN			MMIO8(USB_BASE + 0x7B)
...
/* USB Type Endpoint [0-15] */
#define USB_TYPE(n)			MMIO8(USB_BASE + 0x10A + n * 0x10)
 ...
 * ---------------------------------------------------------------------------*/
/** Function Address */
#define USB_FADDR_FUNCADDR_MASK		(0x7f << 0)
 ...
 * USB_TXDPKTBUFDIS
 * ---------------------------------------------------------------------------*/
#define USB_EP15			(1 << 15)
#define USB_EP14			(1 << 14)
#define USB_EP13			(1 << 13)
#define USB_EP12			(1 << 12)
#define USB_EP11			(1 << 11)
#define USB_EP10			(1 << 10)
#define USB_EP9				(1 << 9)
#define USB_EP8				(1 << 8)
#define USB_EP7				(1 << 7)
#define USB_EP6				(1 << 6)
...
enum usb_ep_interrupt {
	...
	USB_EP8_INT			= USB_EP8,
	USB_EP9_INT			= USB_EP9,
	USB_EP10_INT			= USB_EP10,
	USB_EP11_INT			= USB_EP11,
	USB_EP12_INT			= USB_EP12,
	USB_EP13_INT			= USB_EP13,
	USB_EP14_INT			= USB_EP14,
	USB_EP15_INT			= USB_EP15,
};
/* =============================================================================
 * Function prototypes
 * ---------------------------------------------------------------------------*/
