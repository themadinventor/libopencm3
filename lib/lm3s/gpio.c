...
#define SYSCTL_GPIOHBCTL	SYSTEMCONTROL_GPIOHBCTL
 ...
 *
 * On the LM3S, the NMI and JTAG/SWD default to their alternate function. These
 ...
 *
 * For example, to unlock the PC0 pin (TCK on the LM3S5956):
 * @code
 *	// PC0 is a JTAG pin, and needs to be unlocked
 *	gpio_unlock_commit(GPIOC, GPIO0);
 ...
 * function.
 *
 * Because AF0 is not used on the LM3S, passing 0 as the alt_func_num parameter
